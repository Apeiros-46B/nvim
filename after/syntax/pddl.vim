...
syn match pddlType '[A-Z][a-z0-9_-]\+'
syn match pddlReq ':[a-z\-]\+'

syn keyword pddlKw define problem domain stream :requirements :domain :init :objects :goal :types :predicates :action :parameters :precondition :effect :derived :stream :inputs :outputs :fluents :certified
